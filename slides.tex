...
\begin{frame}
  ...
  \only<1>{\begin{description}[synthetic algebraic geometry]
  ...
  \only<2->{\center\begin{tikzpicture}
    % need align=* for line breaks
    \node[above,align=center] at (0,0) (start) {Thinking about algebra\\in geometric terms.};

    \node<2>[circle,draw,inner sep=1.2cm] at (-4,-3) (left) {};
    \node<3>[circle,draw,inner sep=2.5cm] at (-4,-3) (left) {};
    \node[align=center] at (left) {(non-synthetic)\\algebraic geometry};
    \node<2>[circle,draw,inner sep=1.2cm] at (4,-3) (right) {};
    \node<3>[circle,draw,inner sep=0.1cm] at (4,-3) (right) {};
    \node<2>[align=center] at (right) {synthetic\\algebraic geometry};
    \path<3> (right.south) node[below,align=center]{synthetic\\algebraic geometry};
